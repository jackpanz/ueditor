...
//	public static String format( String access ,String savePath) {
//		return format(access + "/" + savePath);
//	}
	...
	public static void main(String[] args) {
		String s = "http://www.dog.com//data/upload//\\\\//community/atlas//5407096627927.jpg";
		System.out.println(s.replaceAll("\\\\","/").replaceAll("(?<!(http:|https:))/+","/"));
	}
